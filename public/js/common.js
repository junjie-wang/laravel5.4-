...
function catList(val, level)
{
    ...
    Ajax.call('http://dsc.com/admin/js/goods.php?is_ajax=1&act=sel_cat', 'cat_id='+cat_id+'&cat_level='+level, catListResponse, 'GET', 'JSON');
}
...
function get_select_category(cat_id,cat_level,select_jsId,type)
{
	...
	var page_url='http://dsc.com/admin/js/get_ajax_content.php';
...
function deleteImage(obj, type, id, key)
{
	...
	if(t)
	{
		$.ajax({
			type:'get',
			url:'http://dsc.com/admin/js/zc_project.php',
...
$.jqueryAjax = function(url, data, ajaxFunc, type, dataType)
{
	...
	if(!url)
	{
		url = "http://dsc.com/admin/js/index.php";
	}
...
function get_select_category_pro(obj, cat_id, cat_level, goods_id)
{
	...
	$.jqueryAjax('http://dsc.com/admin/js/goods.php', 'act=get_select_category_pro&cat_id=' + cat_id + '&cat_level=' + cat_level + ex_goods, function(data){
		if(cat_id == 0){
...
function deal_extension_category(obj, goods_id, cat_id, type)
{
	...
	var obj = $(obj);
	$.jqueryAjax("http://dsc.com/admin/js/goods.php", "act=deal_extension_category&goods_id="+goods_id+"&cat_id="+cat_id+"&type="+type + "&other_catids="+other_catids, function(data){
...
function set_attribute_table(goodsId)
{
	...
	$.jqueryAjax('http://dsc.com/admin/js/goods.php', 'act=set_attribute_table&goods_id='+goodsId+'&attr_id='+attr_id_arr+'&attr_value='+attr_value_arr+extension, function(data){
